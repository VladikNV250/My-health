    ...
    return (
        <main className="relative flex flex-col items-center bg-gray-200 w-screen min-h-screen pl-96 pr-20 py-24">
            ...
            <div className="display_btn flex justify-between items-center mt-8">
                <button onClick={startTime} className="flex justify-between items-center space-x-3 bg-white border-2 border-main-500 rounded-l-full px-4 py-2">
                ...
                <button onClick={nextExercise} className="flex justify-between items-center space-x-3 bg-white border-y-2 border-main-500 px-4 py-2">
                ...
                <button onClick={stopTime} className="flex justify-between items-center space-x-3 bg-white border-2 border-main-500 rounded-r-full px-4 py-2">
                    <p>Finish Workout</p>
